...
| M9 Destination-Adjusted Projection | Complete — `player-destination-proj-v1` first real end-to-end run 2026-07-01. 454,790 rows for target_season=2027, 2,125 training rows, CV total_resid_std=2.967 (R²=0.025-0.071). MLflow @champion. Served by `GET /api/players/{id}/projection?school_id=X`. Known gap: `estimate_usage_value_coef` returns fallback 1.5 every run (zero-overlap bug). | Fit style/skill delta empirically (biggest R² gain); fix usage-coef zero-overlap; position-specific competition tier effects; barttorvik as secondary RAPM label. Full roadmap in `../models/destination_projection_plan.md` §19. | [`../models/destination_projection_plan.md`](../models/destination_projection_plan.md); [`../../scripts/run_destination_projection.py`](../../scripts/run_destination_projection.py); [`../../src/portalpoint/modeling/destination_projection.py`](../../src/portalpoint/modeling/destination_projection.py) |
