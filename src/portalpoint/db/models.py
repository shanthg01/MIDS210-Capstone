...
class PlayerTeamFitScore(Base):
    ...
    team_impact_fit: Mapped[Optional[float]] = mapped_column(Float)
    ...
    weight_team_impact: Mapped[float] = mapped_column(
        Float, nullable=False, default=0.20, server_default=text("0.20")
    )
...
class UserPreference(Base):
    ...
    importance_team_impact: Mapped[int] = mapped_column(SmallInteger, default=5, server_default=text("5"))
    ...
    weight_team_impact: Mapped[float] = mapped_column(Float, default=0.20, server_default=text("0.20"))
