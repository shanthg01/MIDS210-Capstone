...
def upgrade() -> None:
    # ── coaches: add tenure_end, departure_date ───────────────────────────────
    op.add_column("coaches", sa.Column("tenure_end", sa.Date(), nullable=True))
    op.add_column("coaches", sa.Column("departure_date", sa.Date(), nullable=True))
    ...
    op.create_index("ix_program_events_school_date", "program_events", ["school_id", "event_date"])
    ...
    op.create_index("ix_peq_school_date", "program_events_review_queue", ["school_id", "event_date"])
...
def downgrade() -> None:
    ...
    op.drop_column("coaches", "departure_date")
    op.drop_column("coaches", "tenure_end")
